...
function! s:install_plugin(mode, buffer)
  ...
  \ {'mode': 'i', 'var': 'user_emmet_next_item_key', 'key': '', 'plug': 'emmet-move-next-item', 'func': '<esc>:call emmet#moveNextPrevItem(0)<cr>'},
  \ {'mode': 'n', 'var': 'user_emmet_next_item_key', 'key': '', 'plug': 'emmet-move-next-item', 'func': ':call emmet#moveNextPrevItem(0)<cr>'},
  \ {'mode': 'i', 'var': 'user_emmet_prev_item_key', 'key': '', 'plug': 'emmet-move-prev-item', 'func': '<esc>:call emmet#moveNextPrevItem(1)<cr>'},
  \ {'mode': 'n', 'var': 'user_emmet_prev_item_key', 'key': '', 'plug': 'emmet-move-prev-item', 'func': ':call emmet#moveNextPrevItem(1)<cr>'},
